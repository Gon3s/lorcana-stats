...
export const store = {
  ...
  _activeDeck:         'all',
  _activeQueue:        'all',
  _activeTurnOrder:    'all',  // 'all' | 'OTP' | 'OTD'
  ...
  setActiveTurnOrder(order)    { this._activeTurnOrder   = order; },
  ...
  getFiltered() {
    return this._allGames
      ...
      .filter(g => this._activeTurnOrder    === 'all' || g.turnOrder   === this._activeTurnOrder)
